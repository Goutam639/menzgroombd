...
`,
    ...
    pkg_6_h4: { en: "Package- 06", bn: "প্যাকেজ- ০৬" },
    pkg_6_p: { en: "Haircut + Beard Cut + Hair wash & Setup + Lip Care + Steam Face Wash", bn: "হেয়ারকাট + দাড়ি কাটা + সেটাপসহ হেয়ার ওয়াশ + লিপ কেয়ার + স্টিম ফেস ওয়াশ" },
    pkg_7_h4: { en: "Package- 07", bn: "প্যাকেজ- ০৭" },
    pkg_7_p: { en: "Haircut + Lip Care + Hair Wash & Setup + Steam Face Wash", bn: "হেয়ারকাট + লিপ কেয়ার + সেটাপসহ হেয়ার ওয়াশ + স্টিম ফেস ওয়াশ" },
    pkg_8_h4: { en: "Package- 08", bn: "Pedicure & Manicure (Regular)" },
    pkg_8_p: { en: "Pedicure & Manicure treatment for men", bn: "পেডিকিউর এবং মেনিকিউর ট্রিটমেন্ট পুরুষদের জন্য" },
    pkg_9_h4: { en: "Pedicure & Manicure with Fair Polish", bn: "প্যাকেজ- ০৯" },
    pkg_9_p: { en: "Pedicure & Manicure with Fair Polish treatment for men", bn: "ফেয়ার পলিশ সহ পেডিকিউর এবং মেনিকিউর ট্রিটমেন্ট পুরুষদের জন্য" },
    /* ── Testimonials ───────────────────────────────────────────────── */
